              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-left pb-12 border-b border-pine-900/60" id="footer_links_grid">
                ...
                <div className="space-y-4 md:col-span-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-display font-extrabold text-cream-100 text-xs tracking-wider uppercase">VALLEYPOINT CAMPSITE</span>
                  </div>
                ...
                <div className="space-y-3">
                  <h4 className="font-display font-bold text-xs text-cream-100 uppercase tracking-wider">Campsite Contacts</h4>
