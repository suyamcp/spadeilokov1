...
export default function App() {
  ...
  const [preselectedRoomId, setPreselectedRoomId] = useState<string>('luxury-cabin');
    ...
    <div className="min-h-screen bg-pine-950 text-cream-50 font-sans selection:bg-gold-500 selection:text-pine-950 antialiased overflow-x-hidden">
      ...
      <AnimatePresence>
        {showNotification && (
          <motion.div
            ...
            className="fixed top-28 left-1/2 -translate-x-1/2 z-[110] px-5 py-3 rounded-xl bg-gold-500 text-pine-950 font-display font-bold text-xs uppercase tracking-wider flex items-center gap-2 shadow-2xl shadow-gold-500/20 border border-gold-300"
            id="toast_notification_hud"
          >
            <Sparkles className="w-4 h-4 text-pine-950" />
      ...
      {showAdmin ? (
        ...
        <div className="animate-fadeIn">
          ...
          <header className="relative min-h-[90vh] flex flex-col justify-between items-center text-center overflow-hidden" id="campsite_hero_billboard">
            ...
            <div className="absolute inset-0 z-0 bg-pine-950">
              {cmsData.hero.backgroundImage ? (
                <img 
                  ...
                  alt="Valleypoint Campsite Atmospheric Backdrop" 
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-pine-950/60 via-transparent to-pine-950" />
              <div className="absolute inset-r-0 h-1/4 bg-gradient-to-t from-transparent to-pine-950/90" />
            </div>
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 flex justify-between sm:justify-end z-10" id="hero_upper_credits">
              <div className="text-left sm:text-right">
                <span className="text-[10px] uppercase font-black tracking-widest text-[#dfba6b]/80 block font-display">
                  EST. 2019 — TUBA BENGUET
                </span>
                <span className="text-[8px] tracking-[0.15em] text-neutral-400 block font-mono mt-0.5">
            ...
            <div className="max-w-4xl mx-auto px-4 z-10 py-16 sm:py-24 flex flex-col items-center justify-center space-y-8 animate-fadeIn" id="hero_title_cta_group">
              ...
              <div className="space-y-4">
                ...
                <h1 className="font-serif font-black text-4xl sm:text-6xl text-cream-50 leading-tight tracking-tight pt-2">
                  {cmsData.hero.title || "[VALLEYPOINT TITLE PLACEHOLDER]"}
                </h1>
                
                <p className="text-sm sm:text-base text-neutral-300 max-w-2xl mx-auto leading-relaxed font-light min-h-[30px]">
                  {cmsData.hero.description || "[This is a placeholder for your campsite introduction paragraph. To customize this text, click on \"Open Admin Panel\" in the system toggle bar at the top of your screen.]"}
                </p>
              </div>
              ...
              <button
                ...
                className="neon-btn-glow py-4 px-10 rounded-full bg-black/90 border-2 border-[#165b32] hover:border-gold-500 hover:bg-gold-500 text-cream-50 hover:text-pine-950 font-display font-extrabold text-sm tracking-[0.2em] transition-all hover:scale-105 active:scale-95 shadow-2xl relative group cursor-pointer"
            ...
            <div className="z-10 pb-8 flex flex-col items-center gap-1.5 cursor-pointer animate-bounce text-neutral-400 hover:text-gold-400" onClick={handleScrollToBooking} id="arrow_indicator">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-left max-w-3xl mb-16 space-y-4">
                ...
                <h2 className="font-serif font-black text-3xl sm:text-4xl text-cream-100 leading-tight">
                  Rates & Campsite Options
                </h2>
                <p className="text-sm text-neutral-400 leading-relaxed max-w-2xl">
                  We offer curated stays designed to fit other guest preferences. From glass lofts looking over valley coordinate views, to cozy glamping suites and raw adventure campsites.
                </p>
              </div>
                    ...
                    >
                      <div>
                        ...
                        <div className="aspect-[4/3] w-full overflow-hidden relative border-b border-pine-850">
                          {room.imageUrl ? (
                            <img 
                              src={room.imageUrl} 
                              alt={room.name || 'Campsite Room Option'} 
                          ...
                          <span className="absolute top-4 right-4 py-1 px-2.5 rounded-lg bg-pine-950/95 backdrop-blur border border-pine-800 text-[9px] font-bold text-gold-400 tracking-wider uppercase font-display">
                            {room.type === 'luxury_cabin' ? 'Premium Suite' : room.type === 'glamping_tent' ? 'Glamping' : 'Campground'}
                          </span>
                        </div>
                      ...
                      <div className="p-6 border-t border-pine-850/40 flex items-center justify-between gap-4">
                        ...
                        <button
                          ...
                          className="py-2.5 px-4 rounded-xl bg-gold-400/15 hover:bg-gold-500 border border-gold-400/20 text-gold-300 hover:text-pine-950 font-display font-bold text-xs transition-all tracking-wider flex items-center gap-1 cursor-pointer select-none"
          ...
          <section id="booking_portal_section" className="py-24 bg-pine-900 border-t border-b border-pine-850 scroll-mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                <span className="text-xs uppercase font-extrabold tracking-widest text-[#dfba6b] font-display flex items-center justify-center gap-2">
                ...
                <p className="text-sm text-neutral-400 leading-relaxed">
                  Verify real-time vacancy coordinates of our wooden loft cabins and geodome glamping tents below. Our booking engine locks dates instantly upon ticket generation.
                </p>
              </div>
          ...
          <footer className="bg-pine-950 border-t border-pine-900/40 text-neutral-400 py-16 text-xs" id="website_footer_node">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-left pb-12 border-b border-pine-900/60" id="footer_links_grid">
                ...
                <div className="space-y-4 md:col-span-1">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-cream-50 border border-gold-500 overflow-hidden flex items-center justify-center p-0.5">
                      <svg className="w-full h-full text-pine-950" viewBox="0 0 100 100">
                        <circle cx="50" cy="50" r="45" fill="#faf9f2" />
                        <path d="M30 75 L50 40 L70 75 Z" fill="#062c15" />
                        <circle cx="50" cy="30" r="5" fill="#c9a054" />
                      </svg>
                    </div>
                    <span className="font-display font-extrabold text-[#faf9f2] text-xs tracking-wider uppercase">VALLEYPOINT CAMPSITE</span>
                  </div>
                  <p className="text-[11px] text-neutral-500 leading-relaxed">
                    Tuba’s pioneer glamping ridge nestled above the clouds. Creating magical alpine stories since 2019 under Benguet's misty pines.
                  </p>
                </div>

                {/* Col 2: Contacts */}
                <div className="space-y-3">
                  <h4 className="font-display font-bold text-xs text-[#faf9f2] uppercase tracking-wider">Campsite Contacts</h4>
                  <ul className="space-y-2 text-[11px]">
                    <li>Phone: +63 917 123 4567 (Glamping Cafe Office)</li>
                    <li>Email: reservations@valleypointcampsite.com</li>
                    <li>Location: Greenvalley, Santo Tomas Rd, Tuba, Benguet</li>
                  </ul>
                </div>

                {/* Col 3: Fast navigation */}
                <div className="space-y-3">
                  <h4 className="font-display font-bold text-xs text-[#faf9f2] uppercase tracking-wider font-display">Fast Navigation</h4>
                  <ul className="space-y-1.5 text-[11px]">
                    <li><a href="#about" className="hover:text-gold-400">Backstory & Elev coordinates</a></li>
                    <li><a href="#rates" className="hover:text-gold-400">Rates & Plot listings</a></li>
                    <li><a href="#services" className="hover:text-gold-400">Amenities & Safety</a></li>
                    <li><a href="#faqs" className="hover:text-gold-400">Rescheduling & Policies</a></li>
                  </ul>
                </div>

                {/* Col 4: Coordinate badges */}
                <div className="space-y-3">
                  <h4 className="font-display font-bold text-xs text-[#faf9f2] uppercase tracking-wider font-display">Operational Hours</h4>
                  <ul className="space-y-1.5 text-[11px] text-neutral-500">
                    <li><span className="text-neutral-300 font-semibold">Campsite Reception:</span> 24 Hours open daily</li>
                    <li><span className="text-neutral-300 font-semibold">Overlook Cafe & Bar:</span> 6:30 AM — 10:00 PM</li>
                    <li><span className="text-neutral-300 font-semibold">Archery Range Hours:</span> 8:00 AM — 5:30 PM</li>
                  </ul>
                </div>
              ...
              <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-neutral-600 font-display font-semibold" id="footer_trademark_bar">
                <span>© 2026 VALLEYPOINT CAMPSITE BAGUIO INC. ALL RIGHTS RESERVED.</span>
