          ...
          <div className="flex items-center gap-3">
            <a href="#" className="flex items-center gap-2 group" id="brand_logo_link">
              ...
              <div className="flex flex-col text-left">
                <span className="font-display font-black text-cream-100 text-sm tracking-widest leading-none">VALLEYPOINT</span>
                <span className="font-display font-bold text-[9px] text-gold-400 tracking-wider">CAMPSITE BAGUIO</span>
              </div>
            </a>
          </div>
